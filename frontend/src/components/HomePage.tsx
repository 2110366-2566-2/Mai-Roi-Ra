...
export default function HomePage() {
  ...
  return (
    <div
      className={`${styles.allFont} flex justify-center items-center 
    ...
    >
      ...
      <div className="relative">
        <div className=" flex flex-row justify-center">
          <h1 className="text-[80px]">MAI ROI RA</h1>
        </div>
        <div
          className={`${styles.allFont} flex flex-row justify-center text-[30px] 
