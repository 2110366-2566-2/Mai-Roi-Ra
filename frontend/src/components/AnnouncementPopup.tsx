...
const AnnouncementPopup = ({ id, name, isVisible, onClose }: Props) => {
  ...
  return (
    <div
      className={`w-screen h-screen fixed inset-0 z-auto top-0 left-0 flex flex-row justify-center items-center bg-opacity-25 bg-black ${styles.Roboto}`}
    >
      {!loading ? (
        <div className="lg:w-[1000px] lg:h-[450px] md:w-[500px] md:h-[350px] w-[350px] h-[300px] bg-white pt-[5px] z-20 rounded-3xl">
          ...
          <div className="px-[25px]">
            <div
              className="lg:text-[40px] md:text-[30px] sm:text-[30px] text-[20px] font-light bg-[#F2D22E] 
                        w-fit flex items-center rounded-3xl px-[20px] 
                        lg:py-[7px] md:py-[5px] sm:py-[3px] py-[3px] relative flex-row"
            >
              <CampaignIcon
                style={{ fontSize: iconSize }}
                className="lg:mr-[10px] md:mr-[8px] sm:mr-[6px] mr-[6px]"
              />{" "}
              Announcement
            </div>
            ...
            <form action={handleSubmit}>
              <div className="w-[50%] relative md:mt-[20px] mt-[15px]">
                <input
                  className={`border-[1px] ${error == 1 ? "border-red-600" : "border-black"} lg:py-[10px] md:py-[8px] py-[7px] h-full w-full lg:indent-4 md:indent-4 indent-3 
              ...
              <div className="w-full relative md:mt-[20px] mt-[15px]">
                <textarea
                  className={`border-[1px] ${error == 2 ? "border-red-600" : "border-black"} w-full lg:py-[10px] md:py-[8px] py-[7px]
              ...
              <div className="flex justify-end items-center md:mt-[15px] mt-[12px]">
                <button
                  type="submit"
                  className="bg-[#F2D22E] lg:w-[15%] md:w-[25%] sm:w-[30%] w-[30%] rounded-full lg:text-[20px] md:text-[15px] sm:text-[12px] text-[12px] py-[5px]"
                >
                  Done
                </button>
              </div>
