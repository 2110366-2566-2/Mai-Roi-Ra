...
export default function ChooseRoleForm({
  ...
  role: string;
  setRole: Function;
  setOpenChooseRoleForm: Function;
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center gap-3 bg-gray-100 p-10 mb-10 mt-5 rounded-lg">
        ...
        <p className="text-center mt-4 text-gray-400">
          Please note, you can only make a selection once.
        </p>
      </div>
      <div className="flex justify-center items-center gap-3 mt-2">
        ...
        {username === "" ? (
          <button
            className="bg-gray-300 text-white font-bold py-2 px-4 rounded cursor-not-allowed w-32 ml-32"
            disabled
          >
            Done
          </button>
          ...
          <button
            className="bg-[#F2D22E] hover:bg-[#FFAE27] text-white font-bold py-2 px-4 rounded w-32 ml-32"
