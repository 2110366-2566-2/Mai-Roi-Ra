    ...
    <div className={`${styles.Roboto} w-full text-black`}>
      <form action={handleSubmit} className="w-full h-full">
        ...
        <div className="lg:flex lg:flex-row lg:flex-wrap lg:justify-between w-full">
          ...
          <div className="lg:w-[48%] w-full md:space-y-[25px] space-y-[20px]">
            <div className="flex flex-start flex-wrap justify-between w-full">
              <div className="w-[48%] relative">
                <input
                  className="border-[1px] border-gray-300 lg:py-[15px] md:py-[13px] py-[11px] h-full w-full lg:indent-4 md:indent-4 indent-3 lg:text-[17px] md:text-[15px] text-[13px]
                                rounded-md"
                  type="text"
              ...
              <div className="w-[48%] relative">
                <FormControl className="w-full lg:h-[52px] md:h-[45px] h-[40px] relative focus:outline-none">
                  <InputLabel className="text-[16px] lg:mt-[-2px] md:mt-[-4px] sm:mt-[-6px] mt-[-8px] focus:outline-none">
                    Activity
                  </InputLabel>
                  <Select
                    value={Activity}
                    className={`border-[1px] border-gray-300 lg:py-[15px] md:py-[13px] py-[11px] h-full w-full 
                                    lg:text-[17px] md:text-[15px] text-[13px] rounded-md focus:outline-none`}
                    readOnly
                  >
                    <MenuItem
                      value="Entertainment"
                    ...
                    <MenuItem value="Exercise" className="focus:outline-none">
                      Exercise
                    </MenuItem>
                    <MenuItem value="Volunteer" className="focus:outline-none">
                      Volunteen
                    </MenuItem>
                    <MenuItem value="Meditation" className="focus:outline-none">
                      Meditation
                    </MenuItem>
                    <MenuItem value="Cooking" className="focus:outline-none">
                      Cooking
                    </MenuItem>
                  </Select>
                </FormControl>
            ...
            <div className="flex flex-start flex-wrap justify-between w-full">
              <div className="w-[48%] relative">
                <input
                  className="border-[1px] border-gray-300 lg:py-[15px] md:py-[13px] py-[11px] 
          ...
          {/* Right Form */}
          <div
            className="lg:h-auto md:h-[300px] sm:h-[200px] h-[200px] lg:w-[47%] w-[full] lg:mt-[0] md:mt-[25px] mt-[20px] border-[1px]
        ...
        <div className="w-full relative md:mt-[25px] mt-[20px]">
          <textarea
            className="border-[1px] border-gray-300 w-full lg:py-[15px] md:py-[13px] py-[11px]  h-[240px] lg:indent-4 md:indent-4 indent-3
        ...
        {/* Button */}
        <div
          className={`w-full flex flex-row flex-wrap justify-around mt-[25px] ${error ? "lg:mb-[30px]" : ""} lg:mb-[0px] mb-[30px]`}
        >
          <div className="">
            <button
              className="bg-[#D9D5D2] lg:py-[17px] md:py-[14px] py-[11px] lg:px-[90px] md:px-[70px] px-[40px] lg:text-[17px] md:text-[13px] 
          ...
          <div className="">
            <button
              type="submit"
              className="bg-[#F2D22E] lg:py-[17px] md:py-[14px] py-[11px] lg:px-[90px] md:px-[70px] px-[40px] 
      ...
      {loading && (
        <div
          className={`w-screen z-30 h-screen fixed inset-0 top-0 left-0 flex flex-row justify-center items-center bg-opacity-25 bg-black ${styles.Roboto}`}
        >
