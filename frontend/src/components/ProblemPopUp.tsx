...
const ProblemPopUp = ({
  ...
  return (
    <div
      className={`w-screen h-screen fixed inset-0 z-20 top-0 left-0 flex flex-row justify-center items-center bg-opacity-25 bg-black ${styles.Roboto}`}
    >
      <div className="lg:w-[1000px] lg:h-[450px] md:w-[500px] md:h-[350px] w-[350px] h-[300px] bg-white pt-[5px] z-20 rounded-3xl">
        ...
        <div className="px-5">
          ...
          <div className="flex justify-end">
            <div
              className="bg-yellow-200 rounded-xl p-4 mb-2"
