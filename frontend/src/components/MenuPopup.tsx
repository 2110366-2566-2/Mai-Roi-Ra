...
const MenuPopup = ({
  ...
  return (
    <div>
      {isVisible ? (
        <div
          className="w-screen h-screen fixed inset-0 flex flex-row justify-center items-center 
        ...
        >
          <div className="fixed left-0 top-0 h-screen w-[50%] bg-white border-r-[1px] border-gray-300 flex flex-col justify-between">
            <div className="flex flex-col pt-4">
              <div className="h-fit">
                <Image
                  className="md:w-[20px] md:h-[20px] h-[15px] w-[15px] absolute top-2 right-2 cursor-pointer"
                  src="/img/cancel.png"
              ...
              <div className="p-4 w-full flex justify-center">
                <Image
                  className="md:w-[60px] md:h-[60px] h-[30px] w-[30px]"
