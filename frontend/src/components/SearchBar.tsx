...
const SearchBar = ({page,last_page,search,history} : Props) => {
    ...
    useEffect(() => {
        router.push(`/homepage?search=${historyBar}`);
    },[historyBar])
                        ...
                        <div className="absolute top-full w-full bg-white shadow-lg max-h-60 overflow-auto z-10">
                            {searchHistory.map((item, index) => (
                                <div 
                                    ...
                                    onMouseEnter={() => {setHistoryBar(item.search_name)}}>
                ...
                <div className="md:w-[40%] w-full flex md:justify-end justify-start flex-row flex-wrap items-center lg:space-x-2 md:space-x-1 space-x-0">
                    {
                        page > 0 && (
                            pageClick ? 
                            <div className="text-gray-500 lg:mr-[20px] md:mr-0 mr-[10px] md:text-[15px] text-[12px] flex flex-row ">
                                <div>
                                    Page
                                </div>
                                ...
                                <div className="relative mx-1">
                                    ...
                                    className={`w-fit border-[1px] border-black indent-1 rounded-md`} ref={pageRef} onKeyDown={(e) => {
                                        if (e.key === 'Enter') {
