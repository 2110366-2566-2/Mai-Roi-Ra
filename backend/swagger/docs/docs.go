...
const docTemplate = `{
        ...
        "/problems/reply/{problem_id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Create or Update Problem Reply Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/structure.CreateOrUpdateProblemReplyRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "structure.CreateOrUpdateProblemReplyRequest": {
            "type": "object",
            "required": [
                "admin_username",
                "problem_id",
